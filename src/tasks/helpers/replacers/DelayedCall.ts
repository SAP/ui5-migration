      ...
      if (
        ...
        if (
          ...
          if (bContainsThis) {
            ...
            oNodeSetTimeout.arguments['0'].arguments = [].concat(aArgs[1]);
          } else {
        ...
        if (bHasParams) {
          oNodeSetTimeout.arguments['0'].arguments = oNodeSetTimeout.arguments[
            '0'
		...
		*/
        ...
        oNodeSetTimeoutBody['1'].consequent.body['0'].expression.right.object =
          aArgs[1];
        ...
        if (bContainsThis) {
          oNodeSetTimeout.arguments['0'].arguments['0'] = builders.identifier(
            'this'
          );
        } else {
