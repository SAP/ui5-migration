	...
	const argsBuilder =
		yargs.group([ "help" ], "Basics:")
			...
			.option("output-format", {
				...
				default : path.join(
					__dirname, "../../defaultConfig/printer.config.json"),
				normalize : true
			})
			.option("task", {
				alias : [ "t" ],
				...
				choices : [
					"all", "replace-globals", "fix-jquery-plugin-imports",
					"apply-amd-syntax", "add-renderer-dependencies",
			...
			.option("loglevel", {
				...
				choices : [
					ReportLevel.TRACE, ReportLevel.DEBUG, ReportLevel.INFO,
					ReportLevel.WARNING, ReportLevel.ERROR
				],
