...
function analyseMigrateAndTest(
	...
	analyse({ file : module, fileFinder, reporter, config, targetVersion })
		...
		.then(function(didModify) {
			assert.strictEqual(
				didModify, expectedModification,
		...
		"#start()", function() {
			it("should replaceGlobals encodeXML", function(done) {
				const expectedContent =
					fs.readFileSync(rootDir + "encodeXML.expected.js", "utf8");
			...
			it("should replaceGlobals but with jQuery usage", function(done) {
				const expectedContent =
					fs.readFileSync(rootDir + "jQ.expected.js", "utf8");
				const config = JSON.parse(
			...
			it("should replaceGlobals and use unique names duplicateVars", function(done) {
				const expectedContent = fs.readFileSync(
					rootDir + "duplicateVars.expected.js", "utf8");
				const config = JSON.parse(fs.readFileSync(
					rootDir + "duplicateVars.config.json", "utf8"));
			...
			it("should replaceGlobals and use existing imports reuseVars",
			   function(done) {
				   const expectedContent = fs.readFileSync(
					   rootDir + "reuseVar.expected.js", "utf8");
				   const config = JSON.parse(fs.readFileSync(
			...
			it("should replaceGlobals unusedGlobals", function(done) {
				const expectedContent = fs.readFileSync(
					rootDir + "unusedGlobals.expected.js", "utf8");
				const config = JSON.parse(fs.readFileSync(
			...
			it("should replaceGlobals asterisk", function(done) {
				const expectedContent =
					fs.readFileSync(rootDir + "asterisk.expected.js", "utf8");
				const config = JSON.parse(
			...
			it("should replaceGlobals startsWith", function(done) {
				const expectedContent =
					fs.readFileSync(rootDir + "endsWith.expected.js", "utf8");
				const config = JSON.parse(
			...
			it("should replaceGlobals isEqualNode", function(done) {
				const expectedContent = fs.readFileSync(
					rootDir + "isEqualNode.expected.js", "utf8");
				const config = JSON.parse(fs.readFileSync(
					rootDir + "isEqualNode.config.json", "utf8"));
			...
			it("should replaceGlobals uriParams", function(done) {
				const expectedContent =
					fs.readFileSync(rootDir + "uriParams.expected.js", "utf8");
				const config = JSON.parse(
				...
				analyseMigrateAndTest(module, true, expectedContent, config, done, [
					...
					"trace: 31: Replace global call with \"sap.base.util.UriParameters\"",
					"trace: 31: Found call to replace \"jQuery.sap.getUriParameters\"",
					...
					"trace: 31: Replaced call \"jQuery.sap.getUriParameters\"",
			...
			it("should replaceGlobals padding", function(done) {
				const expectedContent =
					fs.readFileSync(rootDir + "padding.expected.js", "utf8");
				const config = JSON.parse(
			...
			it("should replaceGlobals delay", function(done) {
				const expectedContent =
					fs.readFileSync(rootDir + "delay.expected.js", "utf8");
				const config = JSON.parse(
			...
			it("should replaceGlobals isMouseEventDelayed", function(done) {
				const expectedContent = fs.readFileSync(
					rootDir + "isMouseEventDelayed.expected.js", "utf8");
				const config = JSON.parse(fs.readFileSync(
					rootDir + "isMouseEventDelayed.config.json", "utf8"));
				const module =
					new CustomFileInfo(rootDir + "isMouseEventDelayed.js");
				analyseMigrateAndTest(module, true, expectedContent, config, done, [
			...
			it("should replaceGlobals domById", function(done) {
				const expectedContent =
					fs.readFileSync(rootDir + "domById.expected.js", "utf8");
				const config = JSON.parse(
			...
			it("should replaceGlobals removeUrlWhitelist", function(done) {
				const expectedContent = fs.readFileSync(
					rootDir + "removeUrlWhitelist.expected.js", "utf8");
				const config = JSON.parse(fs.readFileSync(
					rootDir + "removeUrlWhitelist.config.json", "utf8"));
				const module =
					new CustomFileInfo(rootDir + "removeUrlWhitelist.js");
				analyseMigrateAndTest(module, true, expectedContent, config, done, [
			...
			it("should replaceGlobals jqueryDomById", function(done) {
				const expectedContent =
					fs.readFileSync(rootDir + "jqueryDom.expected.js", "utf8");
				const config = JSON.parse(
			...
			it("should replaceGlobals inArray", function(done) {
				const expectedContent =
					fs.readFileSync(rootDir + "inArray.expected.js", "utf8");
				const config = JSON.parse(
			...
			it("should replaceGlobals intervalCall", function(done) {
				const expectedContent =
					fs.readFileSync(rootDir + "interval.expected.js", "utf8");
				const config = JSON.parse(fs.readFileSync(
					rootDir + "intervalCall.config.json", "utf8"));
			...
			it("should replaceGlobals moduleWithInvocation", function(done) {
				const expectedContent = fs.readFileSync(
					rootDir + "moduleWithInvoc.expected.js", "utf8");
				const config = JSON.parse(fs.readFileSync(
					rootDir + "moduleWithInvoc.config.json", "utf8"));
				const module =
					new CustomFileInfo(rootDir + "moduleWithInvoc.js");
				analyseMigrateAndTest(module, true, expectedContent, config, done, [
			...
			it("should replaceGlobals moduleWithWindowScopedInvocation", function(done) {
				...
				const config = JSON.parse(fs.readFileSync(
					rootDir + "moduleWithScopedInvoc.config.json", "utf8"));
				const module =
					new CustomFileInfo(rootDir + "moduleWithScopedInvoc.js");
				analyseMigrateAndTest(module, true, expectedContent, config, done, [
			...
			it("should replaceGlobals nativeFunction", function(done) {
				const expectedContent = fs.readFileSync(
					rootDir + "nativeFunction.expected.js", "utf8");
				const config = JSON.parse(fs.readFileSync(
					rootDir + "nativeFunction.config.json", "utf8"));
				const module =
			...
			it("should replaceGlobals nativeFunction with argument check",
			   function(done) {
				   const expectedContent = fs.readFileSync(
					   rootDir + "nativeFunctionArgCheck.expected.js");
				   const config = JSON.parse(fs.readFileSync(
					   rootDir + "nativeFunctionArgCheck.config.json", "utf8"));
			...
			it("should replaceGlobals nativeObject", function(done) {
				const expectedContent = fs.readFileSync(
					rootDir + "/nativeObject.expected.js", "utf8");
				const config = JSON.parse(fs.readFileSync(
					rootDir + "nativeObject.config.json", "utf8"));
			...
			it("should replaceGlobals getObject", function(done) {
				const expectedContent =
					fs.readFileSync(rootDir + "getObject.expected.js", "utf8");
				const config = JSON.parse(
			...
			it("should replaceGlobals domFocus", function(done) {
				const expectedContent =
					fs.readFileSync(rootDir + "domFocus.expected.js", "utf8");
				const config = JSON.parse(
			...
			it("should replaceGlobals comments", function(done) {
				const expectedContent =
					fs.readFileSync(rootDir + "comments.expected.js", "utf8");
				const config = JSON.parse(
			...
			it("should ignore non-root sap.ui.define calls", function(done) {
				const expectedContent =
					fs.readFileSync(rootDir + "nonRoot.expected.js", "utf8");
				const config = JSON.parse(
				...
				analyseMigrateAndTest(
					...
					[ "trace: could not find sap.ui.define call" ], "trace");
			});

			it("should replace measure calls", function(done) {
				const expectedContent =
					fs.readFileSync(rootDir + "measure.expected.js", "utf8");
				const config = JSON.parse(
			...
			it("should replace old storage api", function(done) {
				const expectedContent =
					fs.readFileSync(rootDir + "storage.expected.js", "utf8");
				const config = JSON.parse(
			...
			it("should replace version calls", function(done) {
				const expectedContent =
					fs.readFileSync(rootDir + "version.expected.js", "utf8");
				const config = JSON.parse(
			...
			it("should replace log Level calls calls", function(done) {
				const expectedContent =
					fs.readFileSync(rootDir + "loglevel.expected.js", "utf8");
				const config = JSON.parse(
			...
			it("jquery should be left as is", function(done) {
				const expectedContent =
					fs.readFileSync(rootDir + "jquery.expected.js", "utf8");
				const config =
					JSON.parse(fs.readFileSync(rootDir + "jquery.config.json"));
			...
			it("jquery ThirdParty should be left as is", function(done) {
				const expectedContent = fs.readFileSync(
					rootDir + "jqueryThirdParty.expected.js", "utf8");
				const config = JSON.parse(
					fs.readFileSync(rootDir + "jqueryThirdParty.config.json"));
				const module =
					new CustomFileInfo(rootDir + "jqueryThirdParty.js");
				analyseMigrateAndTest(module, true, expectedContent, config, done, [
					"trace: 25: Replace global call with \"sap.ui.thirdparty.jquery\"",
					"trace: 25: Found call to replace \"jQuery.extend\"",
					"trace: 22: Replace global call with \"sap.ui.thirdparty.jquery\"",
			...
			it("ResourceBundle is Bundle should be left as is", function(done) {
				const expectedContent =
					fs.readFileSync(rootDir + "RisBundle.expected.js", "utf8");
				const config = JSON.parse(
			...
			it("jquery support retina", function(done) {
				const expectedContent =
					fs.readFileSync(rootDir + "retina.expected.js", "utf8");
				const config =
					JSON.parse(fs.readFileSync(rootDir + "retina.config.json"));
			...
			it("jquery os", function(done) {
				const expectedContent =
					fs.readFileSync(rootDir + "jqueryos.expected.js", "utf8");
				const config = JSON.parse(
			...
			it("jquery os require", function(done) {
				const expectedContent = fs.readFileSync(
					rootDir + "jqueryos.require.expected.js", "utf8");
				const config = JSON.parse(
					fs.readFileSync(rootDir + "jqueryos.require.config.json"));
				const module =
					new CustomFileInfo(rootDir + "jqueryos.require.js");
				analyseMigrateAndTest(module, true, expectedContent, config, done, [
					"trace: 23: Replace global call with \"sap.ui.Device\"",
					"trace: 23: Found call to replace \"jQuery.os.os\"",
					"trace: 24: Replace global call with \"sap.ui.Device\"",
			...
			it("jquery os invalid require", function(done) {
				...
				const module =
					new CustomFileInfo(rootDir + "jqueryos.invalid.require.js");
				analyseMigrateAndTest(
					module, false, expectedContent, config, done,
					[ "" +
			...
			it("jquery os name", function(done) {
				const expectedContent = fs.readFileSync(
					rootDir + "jqueryosname.expected.js", "utf8");
				const config = JSON.parse(
			...
			it("jquery device is standalone", function(done) {
				...
				const module =
					new CustomFileInfo(rootDir + "jquerydeviceisstandalone.js");
				analyseMigrateAndTest(module, true, expectedContent, config, done, [
			...
			it("jquery device is iphone", function(done) {
				const expectedContent = fs.readFileSync(
					rootDir + "jquerydeviceisiphone.expected.js", "utf8");
				const config = JSON.parse(fs.readFileSync(
					rootDir + "jquerydeviceisiphone.config.json"));
				const module =
					new CustomFileInfo(rootDir + "jquerydeviceisiphone.js");
				analyseMigrateAndTest(module, true, expectedContent, config, done, [
					"trace: 23: Replace global call with \"sap.ui.Device\"",
			...
			it("should AddComment", function(done) {
				const expectedContent =
					fs.readFileSync(rootDir + "addcomment.expected.js", "utf8");
				const config = JSON.parse(
			...
			it("should not remove dependency when assigning", function(done) {
				const expectedContent = fs.readFileSync(
					rootDir + "assignmodfunc.expected.js", "utf8");
				const config = JSON.parse(
			...
			it("should be able to replace it as part of the arguments (array)",
			   function(done) {
				   const expectedContent =
					   fs.readFileSync(rootDir + "mock.expected.js", "utf8");
				   const config = JSON.parse(
			...
			it("should set import names if necessary", function(done) {
				const expectedContent = fs.readFileSync(
					rootDir + "unset_global.expected.js", "utf8");
				const config = JSON.parse(
			...
			it("should generate Getter", function(done) {
				const expectedContent =
					fs.readFileSync(rootDir + "getter.expected.js", "utf8");
				const config =
					JSON.parse(fs.readFileSync(rootDir + "getter.config.json"));
			...
			it("jstokenizer replacement with new", function(done) {
				const expectedContent = fs.readFileSync(
					rootDir + "jstokenizer.expected.js", "utf8");
				const config = JSON.parse(
			...
			it("should generate noop functions", function(done) {
				const expectedContent =
					fs.readFileSync(rootDir + "gennoop.expected.js", "utf8");
				const config = JSON.parse(
			...
			it("should generate no duplicate jquery parameters", function(done) {
				const expectedContent = fs.readFileSync(
					rootDir + "duplication.expected.js", "utf8");
				const config = JSON.parse(
			...
			it("should replace each calls", function(done) {
				const expectedContent =
					fs.readFileSync(rootDir + "each.expected.js", "utf8");
				const config =
					JSON.parse(fs.readFileSync(rootDir + "each.config.json"));
			...
			it("should handle missing dependencies", function(done) {
				const expectedContent = fs.readFileSync(
					rootDir + "missingDependency.expected.js", "utf8");
				const config = JSON.parse(
					fs.readFileSync(rootDir + "missingDependency.config.json"));
				const module =
					new CustomFileInfo(rootDir + "missingDependency.js");
				analyseMigrateAndTest(module, true, expectedContent, config, done, [
					"trace: 24: Replace global call with \"sap.ui.events.isMouseEventDelayed\"",
					"trace: 24: Found call to replace \"jQuery.sap.isMouseEventDelayed\"",
					"trace: 25: Replace global call with \"sap.ui.events.isMouseEventDelayed\"",
			...
			it("should replace endsWithIgnoreCase", function(done) {
				const expectedContent = fs.readFileSync(
					rootDir + "endsWithIgnoreCase.expected.js", "utf8");
				const config = JSON.parse(fs.readFileSync(
					rootDir + "endsWithIgnoreCase.config.json"));
				const module =
					new CustomFileInfo(rootDir + "endsWithIgnoreCase.js");
				analyseMigrateAndTest(module, true, expectedContent, config, done, [
			...
			it("should replace startsWithIgnoreCase", function(done) {
				const expectedContent = fs.readFileSync(
					rootDir + "startsWithIgnoreCase.expected.js", "utf8");
				const config = JSON.parse(fs.readFileSync(
					rootDir + "startsWithIgnoreCase.config.json"));
				const module =
					new CustomFileInfo(rootDir + "startsWithIgnoreCase.js");
				analyseMigrateAndTest(module, true, expectedContent, config, done, [
					"trace: 24: Deprecated call of type startsOrEndsWithIgnoreCase",
			...
			it("resourceModulePaths", function(done) {
				const expectedContent = fs.readFileSync(
					rootDir + "resourceModulePaths.expected.js", "utf8");
				const config = JSON.parse(fs.readFileSync(
					rootDir + "resourceModulePaths.config.json"));
				const module =
					new CustomFileInfo(rootDir + "resourceModulePaths.js");
				analyseMigrateAndTest(module, true, expectedContent, config, done, [
			...
			it("ModuleSystem", function(done) {
				const expectedContent = fs.readFileSync(
					rootDir + "ModuleSystem.expected.js", "utf8");
				const config = JSON.parse(
			...
			it("isPlainObject", function(done) {
				const expectedContent = fs.readFileSync(
					rootDir + "isPlainObject.expected.js", "utf8");
				const config = JSON.parse(
			...
			it("isPlainObject with other jQuery", function(done) {
				const expectedContent = fs.readFileSync(
					rootDir + "isPlainObject2.expected.js", "utf8");
				const config = JSON.parse(
					fs.readFileSync(rootDir + "isPlainObject2.config.json"));
				const module =
					new CustomFileInfo(rootDir + "isPlainObject2.js");
				analyseMigrateAndTest(module, true, expectedContent, config, done, [
					"trace: 25: Replace global call with \"sap.base.util.isPlainObject\"",
					"trace: 25: Found call to replace \"jQuery.isPlainObject\"",
			...
			it("sap.ui.define is after another call", function(done) {
				const expectedContent = fs.readFileSync(
					rootDir + "laterSapDefine.expected.js", "utf8");
				const config = JSON.parse(
					fs.readFileSync(rootDir + "laterSapDefine.config.json"));
				const module =
					new CustomFileInfo(rootDir + "laterSapDefine.js");
				analyseMigrateAndTest(module, true, expectedContent, config, done, [
			...
			it("should replace jquery.extend", function(done) {
				const expectedContent = fs.readFileSync(
					rootDir + "jqueryExtend.expected.js", "utf8");
				const config = JSON.parse(
			...
			it("should replace jquery.extend SkipImport", function(done) {
				const expectedContent = fs.readFileSync(
					rootDir + "jqueryExtendSkipImport.expected.js", "utf8");
				const config = JSON.parse(fs.readFileSync(
			...
			it("should replace only matching version replacement",
			   function(done) {
				   const expectedContent = fs.readFileSync(
					   rootDir + "versionReplacement.expected.js", "utf8");
				   const config = JSON.parse(fs.readFileSync(
					   rootDir + "versionReplacement.config.json", "utf8"));
				   const module =
					   new CustomFileInfo(rootDir + "versionReplacement.js");
				   analyseMigrateAndTest(
					   module, true, expectedContent, config, done,
					   [
			...
			it("should replace and leave dependency for assign and add dependency for merge extendAndAssign",
			   function(done) {
				   const expectedContent = fs.readFileSync(
					   rootDir + "extendAndAssign.expected.js", "utf8");
				   const config = JSON.parse(fs.readFileSync(
					   rootDir + "extendAndAssign.config.json", "utf8"));
				   const module =
					   new CustomFileInfo(rootDir + "extendAndAssign.js");
				   analyseMigrateAndTest(module, true, expectedContent, config, done, [
					   "trace: 26: Replace global call with \"sap.base.util.merge\"",
					   "trace: 26: Found call to replace \"jQuery.sap.extend\"",
					   "trace: 28: Replace global call with \"sap.base.util.merge\"",
			...
			it("should replace jQuery.trim()", function(done) {
				const expectedContent =
					fs.readFileSync(rootDir + "jqueryTrim.expected.js", "utf8");
				const config = JSON.parse(fs.readFileSync(
			...
			it("should replace jQuery.contains", function(done) {
				const expectedContent = fs.readFileSync(
					rootDir + "jQueryContains.expected.js", "utf8");
				const config = JSON.parse(fs.readFileSync(
					rootDir + "jQueryContains.config.json", "utf8"));
				const module =
					new CustomFileInfo(rootDir + "jQueryContains.js");
				analyseMigrateAndTest(
					module, true, expectedContent, config, done, [
			...
			it("should replace spy and stub calls from sinon", function(done) {
				const expectedContent =
					fs.readFileSync(rootDir + "testSpies.expected.js", "utf8");
				const config = JSON.parse(
			...
			it("should replace variable assignments", function(done) {
				const expectedContent = fs.readFileSync(
					rootDir + "variableAssignment.expected.js", "utf8");
				const config = JSON.parse(fs.readFileSync(
					rootDir + "variableAssignment.config.json", "utf8"));
				const module =
					new CustomFileInfo(rootDir + "variableAssignment.js");
				analyseMigrateAndTest(
					module, true, expectedContent, config, done, [
			...
			it("should replace jQuery.extend properly", function(done) {
				const expectedContent = fs.readFileSync(
					rootDir + "jqueryExtendVars.expected.js", "utf8");
				const config = JSON.parse(fs.readFileSync(
					rootDir + "jqueryExtendVars.config.json", "utf8"));
				const module =
					new CustomFileInfo(rootDir + "jqueryExtendVars.js");
				analyseMigrateAndTest(module, true, expectedContent, config, done, [
					"trace: 24: Replace global call with \"sap.ui.thirdparty.jquery\"",
					"trace: 24: Found call to replace \"jQuery.extend\"",
					"trace: 24: Replaced call \"jQuery.extend\"",
			...
			it("extendImport", function(done) {
				const expectedContent = fs.readFileSync(
					rootDir + "extendImport.expected.js", "utf8");
				const config = JSON.parse(fs.readFileSync(
					rootDir + "extendImport.config.json", "utf8"));
			...
			it("invalidDefine", function(done) {
				const expectedContent = fs.readFileSync(
					rootDir + "invalidDefine.expected.js", "utf8");
				const config = JSON.parse(fs.readFileSync(
					rootDir + "invalidDefine.config.json", "utf8"));
			...
			it("leave with comment", function(done) {
				const expectedContent =
					fs.readFileSync(rootDir + "leave.expected.js", "utf8");
				const config = JSON.parse(
