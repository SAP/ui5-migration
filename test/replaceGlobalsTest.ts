...
describe('replaceGlobals', function() {
  describe('#start()', function() {
    ...
    it('should replaceGlobals isMouseEventDelayed', function(done) {
      ...
      const config = JSON.parse(
        fs.readFileSync(rootDir + 'isMouseEventDelayed.config.json', 'utf8')
      );
      const module = new CustomFileInfo(rootDir + 'isMouseEventDelayed.js');
      analyseMigrateAndTest(module, true, expectedContent, config, done, [
    ...
    it('should replaceGlobals removeUrlWhitelist', function(done) {
      ...
      const config = JSON.parse(
        fs.readFileSync(rootDir + 'removeUrlWhitelist.config.json', 'utf8')
      );
      const module = new CustomFileInfo(rootDir + 'removeUrlWhitelist.js');
      analyseMigrateAndTest(module, true, expectedContent, config, done, [
    ...
    it('should replaceGlobals moduleWithWindowScopedInvocation', function(done) {
      ...
      const config = JSON.parse(
        fs.readFileSync(rootDir + 'moduleWithScopedInvoc.config.json', 'utf8')
      );
      const module = new CustomFileInfo(rootDir + 'moduleWithScopedInvoc.js');
      analyseMigrateAndTest(module, true, expectedContent, config, done, [
    ...
    it('should replaceGlobals nativeFunction with argument check', function(done) {
      ...
      const config = JSON.parse(
        fs.readFileSync(rootDir + 'nativeFunctionArgCheck.config.json', 'utf8')
      );
      const module = new CustomFileInfo(rootDir + 'nativeFunctionArgCheck.js');
      analyseMigrateAndTest(module, true, expectedContent, config, done, [
    ...
    it('jquery os invalid require', function(done) {
      ...
      const config = JSON.parse(
        fs.readFileSync(rootDir + 'jqueryos.invalid.require.config.json')
      );
    ...
    it('jquery device is standalone', function(done) {
      ...
      const config = JSON.parse(
        fs.readFileSync(rootDir + 'jquerydeviceisstandalone.config.json')
      );
      const module = new CustomFileInfo(
    ...
    it('jquery device is iphone', function(done) {
      ...
      const module = new CustomFileInfo(rootDir + 'jquerydeviceisiphone.js');
      analyseMigrateAndTest(module, true, expectedContent, config, done, [
        'trace: 23: Replace global call with "sap.ui.Device"',
    ...
    it('should be able to replace it as part of the arguments (array)', function(done) {
      ...
      const config = JSON.parse(fs.readFileSync(rootDir + 'mock.config.json'));
    ...
    it('should replace each calls', function(done) {
      ...
      const config = JSON.parse(fs.readFileSync(rootDir + 'each.config.json'));
    ...
    it('should replace endsWithIgnoreCase', function(done) {
      ...
      const module = new CustomFileInfo(rootDir + 'endsWithIgnoreCase.js');
      analyseMigrateAndTest(module, true, expectedContent, config, done, [
    ...
    it('should replace startsWithIgnoreCase', function(done) {
      ...
      const module = new CustomFileInfo(rootDir + 'startsWithIgnoreCase.js');
      analyseMigrateAndTest(module, true, expectedContent, config, done, [
        'trace: 24: Deprecated call of type startsOrEndsWithIgnoreCase',
    ...
    it('resourceModulePaths', function(done) {
      ...
      const module = new CustomFileInfo(rootDir + 'resourceModulePaths.js');
      analyseMigrateAndTest(module, true, expectedContent, config, done, [
    ...
    it('should replace jquery.extend SkipImport', function(done) {
      ...
      const module = new CustomFileInfo(rootDir + 'jqueryExtendSkipImport.js');
      analyseMigrateAndTest(
        module,
        true,
        expectedContent,
        ...
        [
          {
            fileName: './test/replaceGlobals/jqueryExtendSkipImport.js',
            location: {
              endColumn: 25,
              endLine: 22,
              startColumn: 12,
    ...
    it('should replace only matching version replacement', function(done) {
      ...
      const config = JSON.parse(
        fs.readFileSync(rootDir + 'versionReplacement.config.json', 'utf8')
      );
      const module = new CustomFileInfo(rootDir + 'versionReplacement.js');
      analyseMigrateAndTest(
        module,
        true,
        expectedContent,
    ...
    it('should replace variable assignments', function(done) {
      ...
      const config = JSON.parse(
        fs.readFileSync(rootDir + 'variableAssignment.config.json', 'utf8')
      );
      const module = new CustomFileInfo(rootDir + 'variableAssignment.js');
      analyseMigrateAndTest(module, true, expectedContent, config, done, [
    ...
    it('should replace jQuery.extend properly', function(done) {
      ...
      const config = JSON.parse(
        fs.readFileSync(rootDir + 'jqueryExtendVars.config.json', 'utf8')
      );
