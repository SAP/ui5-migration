...
sap.ui.define(["sap/ui/core/Control", "addRenderers/myControlRenderer"],
	function(Control, myControlRenderer) {
		 ...
		 *
		 */
		var MyTestControl = Control.extend("addRenderers.myTestControl", /** @lends test.MyTestControl.prototype */ {
			metadata: {
