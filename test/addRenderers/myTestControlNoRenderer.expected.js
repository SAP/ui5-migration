...
sap.ui.define(["sap/ui/core/Control", "./myTestControlNoRendererRenderer"],
	function(Control, myTestControlNoRendererRenderer) {
		"use strict";
		...
		var MyTestControl = Control.extend("test.MyTestControl", /** @lends test.MyTestControl.prototype */ {
		    ...
		    renderer: myTestControlNoRendererRenderer
		});
