...
function analyseMigrateAndTest(
	...
	expectedReports: string[] = [], level = ReportLevel.DEBUG,
	oOutputFormat: {} = {}) {
	...
	analyse({ file : module, fileFinder, reporter, config })
		...
		.then(function(didModify) {
			...
			const actualContent =
				recast.print(module.getAST(), oOutputFormat).code;
	...
	[{
	 ...
	 },
	 {
		 ...
		 apiVersion : {
			 ...
			 gav : "com.sap.ui5.dist:sapui5-sdk-dist:1.63.0-SNAPSHOT:war",
			 libraries :
				 [ { name : "sap.ui.core" }, { name : "sap.ushell" } ]
		 }
	 },
	 {
		 title : "objectPath",
	 ...
	 },
	 {
		...
		it(fixture.title, function(done) {
			...
			const expectedContent =
				fs.readFileSync(rootDir + fixture.expectedCodeFileName, "utf8");
			...
			if (fixture.namespaces) {
				namespace =
					FileFinder.getNamespace(sourceCodeFile, fixture.namespaces);
			}
			analyseMigrateAndTest(
				...
				done, fixture.logs, undefined, fixture.oOutputFormat);
		});
	});
});
