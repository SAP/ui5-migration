...
describe("AmdCleaner ui52amd", function() {
	...
	[
		...
		{
			title: "first line comment",
			sourceCodeFileName: "amdCleanup/commentfstline.js",
			expectedCodeFileName: "amdCleanup/commentfstline.expected.js",
			logs: [
				"debug: 6: remove jQuery.sap.declare(sap.mods.Component)",
				"debug: 1: jQuery.sap.require(sap.ui.core.UIComponent)",
				"debug: 2: jQuery.sap.require(sap.ui.core.routing.History)",
				"debug: 3: jQuery.sap.require(sap.m.routing.RouteMatchedHandler)",
				"debug: 1: Create empty define call",
				"debug: 6: remove jQuery.sap.declare(sap.mods.Component)",
				"debug: 8: Added variable declaration component",
				"debug: 1: jQuery.sap.require(sap.ui.core.UIComponent)",
				"debug:   add import UIComponent <= sap/ui/core/UIComponent",
				"debug: 1:   transformed to dependencies: jQuery.sap.require(sap.ui.core.UIComponent)",
				"debug: 2: jQuery.sap.require(sap.ui.core.routing.History)",
				"debug:   add import RoutingHistory <= sap/ui/core/routing/History",
				"debug: 2:   transformed to dependencies: jQuery.sap.require(sap.ui.core.routing.History)",
				"debug: 3: jQuery.sap.require(sap.m.routing.RouteMatchedHandler)",
				"debug:   add import RouteMatchedHandler <= sap/m/routing/RouteMatchedHandler",
				"debug: 3:   transformed to dependencies: jQuery.sap.require(sap.m.routing.RouteMatchedHandler)",
				"debug:   add import coreLibrary <= sap/ui/core/library",
				"debug: 8: Add dependency for sap.ui.core",
				"debug: 8:   replace sap.ui.core with coreLibrary",
				"debug: 8: Replace occurrence of coreLibrary",
				"debug: 61: Add dependency for sap.ui.core",
				"debug: 61:   replace sap.ui.core with coreLibrary",
				"debug: 61: Replace occurrence of coreLibrary",
				"debug: 68: Add dependency for sap.ui.core",
				"debug: 68:   replace sap.ui.core with coreLibrary",
				"debug: 68: Replace occurrence of coreLibrary",
				"debug: Added return statement of component",
				"debug: Added true for global export",
			],
			modified: true,
