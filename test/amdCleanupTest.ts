...
function analyseMigrateAndTest(
  ...
  analyse({ file: module, fileFinder, reporter, config })
    ...
    .then(function(didModify) {
      ...
      const actualContent = recast.print(module.getAST(), oOutputFormat).code;
...
describe('AmdCleaner ui52amd', function() {
  ...
  [
    ...
    },
    {
      ...
      api: {
        'sap.ui.core': rootDir + 'amdCleanup/duplicateExportVar.api.json',
      },
    },
    {
      ...
      api: {
        'sap.ui.core': rootDir + 'amdCleanup/ModelReturnModule.api.json',
      },
    },
    {
    ...
    },
    {
      ...
      expectedCodeFileName: 'amdCleanup/ComponentReturnModule.expected.js',
      logs: [
      ...
      api: {
        'sap.ui.generic.app': rootDir + 'amdCleanup/genericApp.api.json',
      },
      apiResources: {
        'sap.ui.generic.app': rootDir + 'amdCleanup/genericApp.resources.json',
      },
      apiVersion: {
        ...
        libraries: [{ name: 'sap.ui.core' }, { name: 'sap.ui.generic.app' }],
      },
    },
    {
      title: 'Complex components should be properly returned',
      sourceCodeFileName: 'amdCleanup/ComponentReturnModuleAdv.js',
      expectedCodeFileName: 'amdCleanup/ComponentReturnModuleAdv.expected.js',
      logs: [
        'debug: 1: remove jQuery.sap.declare(mine.Component)',
        'debug: 3: jQuery.sap.require(sap.ui.generic.app.AppComponent)',
        'debug: 1: Create empty define call',
    ...
    },
    {
      ...
      sourceCodeFileName: 'amdCleanup/declareWithExplicitGlobalReference.js',
    ...
    },
    {
      ...
      api: {
        ...
        'sap.ushell': rootDir + 'amdCleanup/blackListed.ushell.api.json',
      },
      apiVersion: {
        name: 'SAPUI5 Distribution',
        version: '1.63.0-SNAPSHOT',
    ...
    },
    {
      ...
      expectedCodeFileName: 'amdCleanup/emptyDefineWithContent.expected.js',
      logs: [
        'debug: found define call at position 0',
        'debug: found define call at position 0',
        'debug:   add import JSONModel <= sap/ui/model/json/JSONModel',
      ...
      api: {
        'sap.ui.core': rootDir + 'amdCleanup/emptyDefineWithContent.api.json',
      },
    },
    {
      title: 'Model should be properly returned outputformat',
      sourceCodeFileName: 'amdCleanup/ModelReturnModuleFormat.js',
      expectedCodeFileName: 'amdCleanup/ModelReturnModuleFormat.expected.js',
      logs: [
        'debug: 1: jQuery.sap.require(sap.m.MessageBox)',
        'debug: 1: Create empty define call',
        'debug: 3: Added variable declaration applicationModel',
      ...
      api: {
        'sap.ui.core': rootDir + 'amdCleanup/ModelReturnModuleFormat.api.json',
      },
      oOutputFormat: {
        tabWidth: 4,
        useTabs: true,
    ...
    it(fixture.title, function(done) {
      ...
      if (fixture.namespaces) {
        namespace = FileFinder.getNamespace(sourceCodeFile, fixture.namespaces);
      }
