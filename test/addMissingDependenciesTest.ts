...
function analyseMigrateAndTest(
	...
	expectedReports: string[] = [], level = "debug") {
	...
	describe("#start()", function() {
		it("should addMissingDependencies", function(done) {
			const expectedContent =
				fs.readFileSync(rootDir + "test.expected.js", "utf8");
		...
		it("should addMissingDependencies for FunctionFinder", function(done) {
			const expectedContent =
				fs.readFileSync(rootDir + "test2.expected.js", "utf8");
			const config = JSON.parse(
		...
		it("should addMissingDependencies only for jQuery calls",
		   function(done) {
			   const expectedContent =
				   fs.readFileSync(rootDir + "control.expected.js", "utf8");
			   const config = JSON.parse(
		...
		it("should addMissingDependencies for jQuery.Event", function(done) {
			const expectedContent =
				fs.readFileSync(rootDir + "event.expected.js", "utf8");
			const config = JSON.parse(
		...
		it("should addMissingDependencies for jQuery.Event.getPseudoTypes",
		   function(done) {
			   const expectedContent =
				   fs.readFileSync(rootDir + "pseudotypes.expected.js", "utf8");
			   const config = JSON.parse(fs.readFileSync(
				   rootDir + "pseudotypes.config.json", "utf8"));
		...
		it("should addMissingDependencies for jQuery selectors",
		   function(done) {
			   const expectedContent =
				   fs.readFileSync(rootDir + "selector.expected.js", "utf8");
			   const config = JSON.parse(
		...
		it("should addMissingDependencies for multiple with mixed addImport and addUnusedImport",
		   function(done) {
			   const expectedContent =
				   fs.readFileSync(rootDir + "multiple.expected.js", "utf8");
			   const config = JSON.parse(
		...
		it("add import with comment", function(done) {
			const expectedContent = fs.readFileSync(
				rootDir + "addCommentToImport.expected.js", "utf8");
			const config = JSON.parse(fs.readFileSync(
				rootDir + "addCommentToImport.config.json", "utf8"));
			const module =
				new CustomFileInfo(rootDir + "addCommentToImport.js");
			analyseMigrateAndTest(
				module, true, expectedContent, config, done, []);
		});
		...
		it("Renaming jQueryDOM", function(done) {
			const expectedContent =
				fs.readFileSync(rootDir + "renaming.expected.js", "utf8");
			const config = JSON.parse(
		...
		it("Renaming jQueryDOM 2 variables", function(done) {
			const expectedContent =
				fs.readFileSync(rootDir + "renamingVars.expected.js", "utf8");
			const config = JSON.parse(
		...
		it("Find jQuery SAP calls", function(done) {
			const expectedContent = fs.readFileSync(
				rootDir + "findJQuerySapCalls.expected.js", "utf8");
			const config = JSON.parse(fs.readFileSync(
				rootDir + "findJQuerySapCalls.config.json", "utf8"));
			const module =
				new CustomFileInfo(rootDir + "findJQuerySapCalls.js");
			analyseMigrateAndTest(
				module, true, expectedContent, config, done, []);
		});
		...
		it("Identify zIndex calls", function(done) {
			const expectedContent =
				fs.readFileSync(rootDir + "zIndex.expected.js", "utf8");
			const config = JSON.parse(
		...
		it("Non zIndex calls", function(done) {
			const expectedContent = fs.readFileSync(
				rootDir + "zIndexNoReplacement.expected.js", "utf8");
			const config = JSON.parse(fs.readFileSync(
				rootDir + "zIndexNoReplacement.config.json", "utf8"));
			const module =
				new CustomFileInfo(rootDir + "zIndexNoReplacement.js");
			analyseMigrateAndTest(
		...
		it("Invalid config, no finder found", function(done) {
			...
			const module =
				new CustomFileInfo(rootDir + "findJQuerySapCalls.js");
			analyseMigrateAndTest(
				module, false, expectedContent, config, null, [])
				.then(() => {
		...
		it("find jQuery.sap.extend", function(done) {
			const expectedContent = fs.readFileSync(
				rootDir + "findJQuerySapExtendCalls.expected.js", "utf8");
			const config = JSON.parse(fs.readFileSync(
				rootDir + "findJQuerySapExtendCalls.config.json", "utf8"));
			const module =
				new CustomFileInfo(rootDir + "findJQuerySapExtendCalls.js");
			analyseMigrateAndTest(
				module, false, expectedContent, config, done, []);
		});
		...
		it("find jQuery.sap functions", function(done) {
			const expectedContent = fs.readFileSync(
				rootDir + "findJQuerySapFunctionCalls.expected.js", "utf8");
			const config = JSON.parse(fs.readFileSync(
				rootDir + "findJQuerySapFunctionCalls.config.json", "utf8"));
			const module =
				new CustomFileInfo(rootDir + "findJQuerySapFunctionCalls.js");
			analyseMigrateAndTest(
				module, false, expectedContent, config, done, []);
		});
		...
		it("invalid define (should not get modified)", function(done) {
			const expectedContent =
				fs.readFileSync(rootDir + "invalidDefine.expected.js", "utf8");
			const config = JSON.parse(
