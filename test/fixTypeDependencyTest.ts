...
function analyseMigrateAndTest(
	...
	expectedContent: string, config: {}, done: Function, expectedReports = [],
	level = "debug") {
	...
	[{
	 ...
	 },
	 {
		...
		it(fixture.title, function(done) {
			...
			const expectedContent = fixture.modified === false ?
				undefined :
			...
			analyseMigrateAndTest(
				new CustomFileInfo(codeToBeMigrated), fixture.modified,
				expectedContent, {
