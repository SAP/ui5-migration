...
describe('FixTypeDependency', function() {
  [
    ...
    },
    {
      ...
      expectedCodeFileName: 'fixTypeDependency/multipleLibraries.expected.js',
      logs: [],
      amdSettings: {},
      api: {
    ...
    },
    {
      ...
      expectedCodeFileName: 'fixTypeDependency/libraryNamespace.expected.js',
      logs: [],
      amdSettings: {},
      api: {
        'sap.ui.table': rootDir + 'fixTypeDependency/_table.api.json',
    ...
    },
    {
      ...
      amdSettings: {},
      api: {
        'sap.ui.core': rootDir + 'fixTypeDependency/libraryDependency.api.json',
      },
      resource: {
        'sap.ui.core': rootDir + 'fixTypeDependency/_core.resources.json',
      },
      executionMode: ProcessingMode.SEQUENTIAL,
    },
    {
      ...
      logs: [],
      amdSettings: {},
      api: { 'sap.ui.table': rootDir + 'fixTypeDependency/_table.api.json' },
      executionMode: ProcessingMode.SEQUENTIAL,
    },
