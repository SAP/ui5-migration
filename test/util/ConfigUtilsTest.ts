import {filterMatchedModules, filterVersionMatches, matchesVersion, removeModulesNotMatchingTargetVersion} from "../../src/util/ConfigUtils";
...
describe("ConfigUtilsTest", function() {
	...
	describe("filterVersionMatches: (happy path)", function() {
		it("Should filter out modules for matching target version", function() {
			const oModules = {
				"Module Root" : {
					"Module A" :
						{ functionName : "functionA", version : "^1.58.0" },
					"Module B" :
						{ functionName : "functionB", version : "^1.40.0" },
					"Module C" :
						{ functionName : "functionC", version : "^1.44.0" }
				}
			};
			...
			const oModules = {
				"Module Root" : {
					"Module A" :
						{ functionName : "functionA", version : "^1.58.0" },
					"Module B" :
						{ functionName : "functionB", version : "^1.44.0" },
					"Module C" :
						{ functionName : "functionC", version : "^1.40.0" }
				}
			};

			const aFilteredMatches = filterMatchedModules(oModules, "1.44.0");
			assert.deepEqual(
				aFilteredMatches, [ "functionB", "functionC" ],
	...
	describe("adjustConfigForTargetVersion: (happy path)", function() {
		it("Should filter out replacers for given modules config", function() {
			...
			const oModifiedConfig =
				removeModulesNotMatchingTargetVersion(oInitialConfig, "1.40.0");
			assert.deepEqual(
				oModifiedConfig, {
					modules : {
						"Module Root" : {
