...
describe('VariableNameCreator', function() {
  ...
  it('getUniqueVariableName', function() {
    ...
    assert.strictEqual(
      VariableNameCreator.getUniqueVariableName(['arguments'], 'arguments'),
      'oArguments',
  ...
  it('getUniqueParameterName', function() {
    ...
    assert.strictEqual(
      VariableNameCreator.getUniqueParameterName(['arguments'], 'arguments'),
      'oArguments',
      'arguments is already taken'
    );
    assert.strictEqual(
    ...
    assert.strictEqual(
      VariableNameCreator.getUniqueParameterName([], 'sap.ui.model.type.Date'),
      'TypeDate',
      'Use namespace'
    );
    assert.strictEqual(
