...
describe('AstStringOptimizeStrategy', function() {
  it('Should optimize batch', async function() {
    ...
    const modified = fs.readFileSync(rootDir + 'batch.modified.js', 'UTF-8');
    const expected = fs.readFileSync(rootDir + 'batch.expected.js', 'UTF-8');
  ...
  it('Should optimize actions', async function() {
    ...
    const modified = fs.readFileSync(rootDir + 'actions.modified.js', 'UTF-8');
    const expected = fs.readFileSync(rootDir + 'actions.expected.js', 'UTF-8');
    const reports = [];
    const astStringOptimizeStrategy = new AstStringOptimizeStrategy(
  ...
  it('Should optimize breaking', async function() {
    ...
    const modified = fs.readFileSync(rootDir + 'breaking.modified.js', 'UTF-8');
    const expected = fs.readFileSync(rootDir + 'breaking.expected.js', 'UTF-8');
    const reports = [];
    const astStringOptimizeStrategy = new AstStringOptimizeStrategy(
      new CustomReporter(reports, 'trace')
    );
